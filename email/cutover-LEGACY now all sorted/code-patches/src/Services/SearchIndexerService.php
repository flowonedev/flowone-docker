...
class SearchIndexerService
{
        ...
        try {
            ...
            foreach ($emails as $email) {
                ...
                try {
                    ...
                    if ($this->indexEmail($userEmail, $message, $canonicalFolder)) {
                        $success++;
                    } else {
                        $errors++;
                    }
     ...
     */
    public function indexEmail(string $userEmail, array $message, ?string $folder = null): bool
    {
    ...
    public function rebuildUserIndex(string $userEmail): array
    {
        ...
        try {
            ...
            error_log("SearchIndexerService rebuildUserIndex attachments general error: " . $e->getMessage());
        }
    ...
    private function extractFileContent(string $mimeType, string $filePath): string
    {
        ...
        // Resolve effective type: if mime is generic octet-stream, detect by extension
        ...
        try {
            ...
            // Markdown by extension fallback
